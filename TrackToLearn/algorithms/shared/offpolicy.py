...
from TrackToLearn.algorithms.so3_actor import SO3EntropyActor
from TrackToLearn.algorithms.so3_actor import SO3Actor, SO3DoubleCritic
...
class SO3TD3ActorCritic(TD3ActorCritic):
    ...
    def __init__(
        ...
        self.actor = SO3Actor(**actor_kwargs).to(device)

        self.critic = SO3DoubleCritic(**critic_kwargs).to(device)

class SO3SACActorCritic(SACActorCritic):
