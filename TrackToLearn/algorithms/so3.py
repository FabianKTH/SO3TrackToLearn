...
from TrackToLearn.algorithms.shared.offpolicy import SO3SACActorCritic, SO3TD3ActorCritic
...
class SO3TD3(TD3):
    ...
    def __init__(
        ...
        self.action_size = action_size
        self.actor_lr = actor_kwargs['actor_lr']
        actor_kwargs.pop('actor_lr')
        self.critic_lr = critic_kwargs['critic_lr']
        critic_kwargs.pop('critic_lr')

        self.gamma = gamma

        # Initialize main policy
        self.policy = SO3TD3ActorCritic(
                {**actor_kwargs, 
