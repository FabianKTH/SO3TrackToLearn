...
def add_experiment_args(parser):
    ...
    parser.add_argument('--skip_validation', action='store_true', help='run '
                        'training without the validation episodes')
...
def add_environment_args(parser):
    ...
    parser.add_argument('--neighborhood_mode', default='star', type=str,
                        help='How to sample neighborhood (center|star|ico|ico-dode|grid)')
    # parser.add_argument('--so3_state', action='store_true',
    #                     help='If set, pass state object with different components')
    ...
    parser.add_argument('--asymmetric', action='store_true',
                        ...
                        'computing reward.')
    parser.add_argument('--init_dirs_from_peaks', action='store_true',
                        help='If set, the historical directionns will be set' +\
                             'from the fod peaks instead of zero')
