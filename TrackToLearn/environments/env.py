...
class BaseEnv(object):
    ...
    def __init__(
        ...
        self.peaks = peaks
        self.peak_volume = torch.tensor(
            peaks.data, dtype=torch.float32, device=env_dto['device'])
        ...
        neighborhood_mode = env_dto['neighborhood_mode']
        self.neighb_from_peaks = env_dto['neighb_from_peaks']
        ...
        self.neighborhood_directions = None
        ...
        # environment
        self.init_dirs_from_peaks = env_dto['init_dirs_from_peaks']
    ...
    def _format_state(
        ...
        signal = get_sh(
            ...
            self.n_signal,
            self.device,
            prev_dir=previous_dirs[:, -1],
            neighb_from_peaks=self.neighb_from_peaks,
