...
from TrackToLearn.algorithms.cql import CQL
...
from TrackToLearn.experiment.train import (
    add_rl_args)
from TrackToLearn.trainers.gym_offline_train import (
    GymOfflineTraining,
...
class CQLGymTraining(GymOfflineTraining):
    """
    ...
    def __init__(
        ...
        K_epochs: int
            ...
            CQL allows for many training runs on the same samples
        eps_clip: float
            Clipping parameter for CQL
        rng_seed: int
